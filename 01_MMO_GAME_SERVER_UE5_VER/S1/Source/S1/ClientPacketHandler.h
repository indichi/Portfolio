...
{
	PKT_S_CONNECT = 1000,
	PKT_C_TRY_LOGIN = 1001,
	PKT_S_TRY_LOGIN = 1002,
	PKT_C_LOGIN = 1003,
	PKT_S_LOGIN = 1004,
	PKT_C_ENTER_GAME = 1005,
	PKT_S_ENTER_GAME = 1006,
	PKT_C_LEAVE_GAME = 1007,
...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_S_TRY_LOGIN] = [](PacketSessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<Protocol::S_TRY_LOGIN>(Handle_S_TRY_LOGIN, session, buffer, len); };
	...
	static SendBufferRef MakeSendBuffer(Protocol::C_TRY_LOGIN& pkt) { return MakeSendBuffer(pkt, PKT_C_TRY_LOGIN); }
